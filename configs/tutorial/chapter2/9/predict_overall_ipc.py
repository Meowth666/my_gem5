baseline_ipc = 0.0
baseline_stats_file = "/gem5/outputs/full-detail-run/stats.txt"
...
for i in range(num_simpoints):
    simpoint_stats_file = f"/gem5/outputs/simpoint{i}-run/stats.txt"
    ...
    simpoint_stdout_file = f"/gem5/outputs/simpoint{i}-run/simout.txt"
    simpoint_weight = 0.0
